...
- **`index.html`** – huvudfil (struktur + inbäddad CSS + innehåll)
- **`app.js`** – logik länkad från samma mapp
- PWA: **`manifest.json`**, **`sw.js`**, **`pwa.js`**, **`version.json`**, **`icons/`**
